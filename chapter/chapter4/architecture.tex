...
\textbf{Microservice} và Client theo  \textbf{MVVC}. Điều này giải quyết yêu cầu \ref{req:scale} giúp hệ thống trở nên linh hoạt trong việc phát triển và mở rộng, nhà 
