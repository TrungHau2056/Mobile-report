...
Activity Diagram "Phát bài hát" mô tả quy trình mà người dùng thực hiện để phát một bài hát 
trên hệ thống. Biểu đồ này thể hiện các hoạt động chính như người dùng chọn bài nhạc để phát, hệ thống xử lý yêu cầu phát nhạc, xử lý các trường hợp lỗi 
và kết thúc bằng việc bài nhạc được phát thành công. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{figures/playingsong-activity.png}
	\caption{Biểu đồ hoạt động chức năng "Phát bài hát"}
\end{figure}
