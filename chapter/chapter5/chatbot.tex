...
Langgraph giúp chhungs tôi xây dựng Chatbot agent theo dạng đồ thị (graph) với các node đại diện cho các thành phần như tool hay agent. Ngoài ra việc dùng Langgraph giúp chúng tôi có thể dễ dàng mở rộng hơn vì nó tối ưu và dễ dàng phát triển để mở
rộng thành hệ thống multi-agent trong tương lai. 
