...
\usepackage{enumitem}
\setlist{
    itemsep=1pt,  % Adjust this value: space between items. Try 0pt for minimal.
    parsep=0pt,   % Space between paragraphs within an item (often good to keep small or 0).
    topsep=0pt    % Space between preceding text and the list. Adjust as needed.
}
...
\input{chapter/chap1_introduction}
\newpage
\input{chapter/chap2_preliminaries.tex}
\newpage
\input{chapter/chap3_requirements.tex}
\newpage
\input{chapter/chap4_system_architecture.tex}
\newpage
\input{chapter/chap5_ai_building.tex}
\newpage
\input{chapter/chap6_testing.tex}
\newpage
\input{chapter/chap7_conclusion.tex}
\newpage


\renewcommand{\bibname}{\vspace{-70pt}\centerline{\fontsize{14}{16}\selectfont\MakeUppercase{Tài liệu tham khảo}}}
